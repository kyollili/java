...
class Super2
{
	...
	public void display()
	{
		System.out.println("Super:dusplay() Call...");
		
	}
	// 생성자, 초기화블록은 상속 안됨 , static은 상속이 아니라 공유
	// private은 상속은 된다 단, 접근은 불가능하다 ==> getter/setter 이용해서 접근
}
class Sub2 extends Super2
{
	...
	/*
	 * ==> 메모리 상에만 저장이 된다 => 메모리가 상속 내린 클래스, 상속을 받은 클래스 => 따로 생성이 된다
	 * ==> 단일 상속만 적용된다
	 ...
	 * 				--------------- 미완성된 클래스 => 완성해서 사용
	 * 
	 * 		***B d=(B)new A(); ==> 형변환의 오류 발생 ==> 하위클래스가 가지고 있는 변수에 접근이 가능
	 * 			=> 라이브러리 클래스에서 주로 사용된다
	 * 
...
public class MainClass_상속_2 {
	...
	public static void main(String[] args) {
		...
		//System.out.println("sup.c="+sup.c); => c에 접근 불가
		
		//Sub2 sub2=new Super(); //Super가 Sub2보다 데이터형이 크기 때문에 오류
		/*Sub2 sub2=(Sub2)new Super2(); //형변환 / a,b,c ==> ClassCastException
