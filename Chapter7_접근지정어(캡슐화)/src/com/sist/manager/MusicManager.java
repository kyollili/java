...
public class MusicManager {
	public static MusicVO[] music=new MusicVO[100]; //초기화
	...
	static
	{
		try
		{
			...
			for(String s:m)
			{
				...
				//변수에 직접 접근이 불가능하기때문에 메소드를 이용해서 저장 --> setXxx()
	...
	//초기화 블록 / 생성자 ==> 파일읽기(구현) => 클래스 영역에서 할 수 없다
	/*
	 * 		변수의 초기화
	 * 		인스턴스
	 * 		정적변수(static)
	 * 		----------------
	 * 			명시적인 초기화		int a=10;
	 * 			초기화 블록	, 생서자 => 파일을 읽어서 초기화, 외부에서 크롤링..
	 * 			-------
	 * 				인스턴스 블록 : 인스턴스변수 초기화
	 * 				{
