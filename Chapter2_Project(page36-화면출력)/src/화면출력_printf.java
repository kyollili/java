 ...
 * 문자
 * 	char(2byte) : 0~65535 =>모든 문자는 번호를  => 'A'(65) 'a'(97) '0'(48)
 * 				  ***연산처리시에 정수형으로 변경
 * 				  ***참조변수 => String
 * 논리
 *  ***boolean (1byte) : true/false
 * 
 * 데이트형 크기 => 피요시에는 언제든지 데이터형을 변경(형변환)
 * ----------
 ...
 *  	%f : 실수
 *  	%s : 문자열
 *  	%d(8진법), %x(16진법), %e(지수), %b(boolean) : 오늘만
 *  
 *  특수문자
 *  -------
 *  	\t =>tab : 일정 간격 처리
...
public class 화면출력_printf {
	...
	public static void main(String[] args) {
		...
		//%5d %-5d ==>3자리
		System.out.printf("%5d%5d%5d",90,80,70);//jdk1.5==>c언어==>printf
