...
public class 메소드_3 {
	...
	{
		System.out.println("first() 진입...");//2
		second();
		System.out.println("first() 종료...");//7
	}
	void second()
	{
		System.out.println("second() 진입...");//3
		last();
		System.out.println("second() 종료...");//6
	}
	void last()
	{
		System.out.println("last() 진입...");//4
		System.out.println("last() 종료...");//5
	}
