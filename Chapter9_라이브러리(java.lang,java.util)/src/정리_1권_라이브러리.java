 ...
 * 							실제로 => 오버라이딩 (변경) ==> String에서 실제 저장된 문자열 비교
 ...
 * 				5) endsWith : 끝문자열이 같은지 여부 : 사용빈도가 거의 없다
 ...
 * 				10) indexOf : 원하는 위치의 문자나 문자열 찾기(앞에서부터)
 * 					원형) public int indexOf(char c)
 * 						 public int indexOf(String c)
 * 							=> 자바에서 문자열은 시작번호가 0번부터
 * 				11) lastIndexOf : 원하는 위치의 문자나 문자열 찾기(뒤에서부터)
 ...
 * 						 public String substring(int s, int e) => e는 제외
 ...
 * 				= Long(long) => parseLong()
 * 				Boxing / UnBoxing
 * 				클래스에 일반 데이터값을 대입 / 기본형에 클래스형을 대입
...
public class 정리_1권_라이브러리 {
	...
	public static void main(String[] args) {
		...
		A a=new A();
		//String s=a.toString(); //입력시엔 생략 불가능
		//System.out.println(a/*toString*/); //출력시엔 생략 가능
